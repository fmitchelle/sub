    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        ...
        <div class="d-flex gap-2">
            <!-- Loading Indicator -->
             ...
             <button id="btnUpdate" class="btn btn-accent" onclick="triggerUpdate()">
...
async function triggerUpdate() {
    ...
    try {
        ...
        for (const src of sources) {
            ...
            try {
                const res = await fetch(`api.php?action=process_source&id=${src.id}`);
        ...
        try {
            const mRes = await fetch('api.php?action=process_manual');
