    ...
    <div class="app-card p-3 p-lg-4">
      ...
      <form id="addClientForm">
        ...
        <div class="mb-3">
          ...
          <input type="number" step="0.1" class="form-control ltr" name="limit" placeholder="خالی یا 0 = نامحدود">
        </div>
        ...
        tr.innerHTML = `
            ...
            <td>
                <button class="btn btn-sm btn-ghost" onclick="copyToClip('${link}')">
                    <span class="material-icons-round fs-6 align-middle">content_copy</span>
                </button>
            </td>
            <td>${limit}</td>
