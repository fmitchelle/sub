    ...
    <div class="app-card p-3 p-lg-4">
      ...
      <form method="post">
        ...
        <div class="mb-2">
          ...
          <input class="form-control" name="custom_label" placeholder="مثلاً: MyBrand">
          <div class="form-text small muted">تغییر نام کانفیگ‌ها به MyBrand_1 و...</div>
        </div>
        <div class="mb-3">
                ...
                <tr>
                  <td>
                      ...
                      <?php if(!empty($s['custom_label'])): ?>
                          <div class="small text-info">#<?php echo h($s['custom_label']); ?></div>
                      <?php endif; ?>
                  </td>
                  <td>
                    <?php if($s['enabled']): ?>
