  ...
  <div class="col-lg-4">
    <div class="app-card p-3 p-lg-4">
      ...
      <form method="post">
        ...
        <div class="mb-2">
          <label class="form-label">نام سفارشی (اختیاری)</label>
          <input class="form-control" name="custom_label" placeholder="مثلاً: MyServer">
          <div class="form-text small muted">تغییر نام تمام سرورهای این لینک.</div>
        </div>
        <div class="mb-3">
          ...
          <tbody>
            ...
            <?php else: ?>
              <?php foreach ($sources as $s): ?>
                <tr>
                  <td>
                      <div class="fw-semibold"><?php echo h($s['name']); ?></div>
                      <?php if(!empty($s['custom_label'])): ?>
                          <div class="small text-info">تغییر نام به: <?php echo h($s['custom_label']); ?></div>
                      <?php endif; ?>
                  </td>
                  <td>
                    <?php if($s['enabled']): ?>
